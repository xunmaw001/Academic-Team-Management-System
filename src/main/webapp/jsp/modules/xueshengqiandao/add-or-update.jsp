		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑学生签到</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学生签到管理</span></li>
								<li class="breadcrumb-item active"><span>编辑学生签到</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生签到信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>签到时间</label>
										<div id="qiandaoshijianDate" class="input-append date form_datetime">
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xueshengqiandao/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("xueshengqiandao/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xueshengqiandao/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xueshengqiandao/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#qiandaoshijian-input").val(getCurDateTime());
		...
		function calculationSE(colName){
			//单列求和接口
			http("xueshengqiandao"+colName,"GET",{
