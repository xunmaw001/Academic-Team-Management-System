...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>学生签到列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生签到列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('qiandaoshijian')">签到时间<i id="qiandaoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var qiandaoshijianCell  = document.createElement('td');

						  qiandaoshijianCell.innerHTML = item.qiandaoshijian;


			row.appendChild(qiandaoshijianCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "学生签退"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'xueshengqiantui','','','')");
			if(crossBtnControl('学生签退') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xueshengqiandao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xueshengqiandao");
