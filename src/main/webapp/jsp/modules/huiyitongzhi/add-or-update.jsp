		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑会议通知</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑会议通知</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">会议通知信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>会议类型</label>
										<select id="huiyileixingSelect" name="huiyileixing" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>封面</label>
									...
									<div class="form-group col-md-6">
										<label>参会人员</label>
										<textarea  name="canhuirenyuan" class="form-control" id="canhuirenyuan" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>教师工号</label>
	...
	<script>
			...
			http("option/huiyileixing/huiyileixing","GET",{},(res)=>{
				if(res.code == 0){
					...
					for(var i=0;i<huiyileixingOptions.length;i++){
						...
						if(ruleForm.huiyileixing == huiyileixingOptions[i]){
							huiyileixingOption.setAttribute('selected','selected');
						}
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "huiyitongzhi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("huiyitongzhi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("huiyitongzhi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("huiyitongzhi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.jiaoshigonghao != null && res.data.jiaoshigonghao != ''){
							$('#jiaoshigonghao').val(res.data.jiaoshigonghao)
							$("#jiaoshigonghao").attr('readonly','readonly');
						}
						if(res.data !=null && res.data.jiaoshixingming != null && res.data.jiaoshixingming != ''){
		...
		function dataBind(){
			...
			var huiyileixingOptions = document.getElementsByClassName("huiyileixingOption");
			for(var huiyileixingCount = 0; huiyileixingCount < huiyileixingOptions.length;huiyileixingCount++){
				if(huiyileixingOptions[huiyileixingCount].getAttribute('value') == ruleForm.huiyileixing){
					huiyileixingOptions[huiyileixingCount].setAttribute('selected','selected');
				}
			}
			...
			$("#canhuirenyuan").val(ruleForm.canhuirenyuan);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.huiyileixing != null && res.data.huiyileixing != ''){

						var huiyileixingOptions = document.getElementsByClassName("huiyileixingOption");
						for(var huiyileixingCount = 0; huiyileixingCount < huiyileixingOptions.length;huiyileixingCount++){
							if(huiyileixingOptions[huiyileixingCount].getAttribute('value') == res.data.huiyileixing){
								huiyileixingOptions[huiyileixingCount].setAttribute('selected','selected');
							}
						}
					}
					...
					if(res.data != null && res.data != '' && res.data.canhuirenyuan != null && res.data.canhuirenyuan != ''){

						$("#canhuirenyuan").val(res.data.canhuirenyuan);
					}
