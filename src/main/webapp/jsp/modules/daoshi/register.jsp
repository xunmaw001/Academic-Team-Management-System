...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20220124/4abae2bee0494faa9a2cfb298b4d3bf6.png) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		border-width: 0 20px;
		border-style: solid;
		border-color: rgba(111, 102, 33, 1);
		background-color: rgba(108, 133, 24, 1);
    ...
    #registerForm .emails .btn {
        ...
        background-color: rgba(111, 102, 33, 1);
        box-shadow: 0 0 0px rgba(0,0,0,.5);
    }
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="jiaoshigonghao" placeholder="教师工号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="jiaoshixingming" placeholder="教师姓名" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">职称</label> 
							<input  name="zhicheng" placeholder="职称" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">电话</label> 
							<input  name="dianhua" placeholder="电话" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "daoshi/register";
				$.ajax({ 
					type: "POST",
					url: url,
