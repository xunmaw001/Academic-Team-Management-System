					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>导师管理</span></li>
								<li class="breadcrumb-item active"><span>编辑导师</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">导师信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>教师工号</label>
										<input name="jiaoshigonghao" readonly id="jiaoshigonghao" name="jiaoshigonghao" class="form-control" placeholder="教师工号">
									</div>
									<div class="form-group col-md-6">
										<label>教师姓名</label>
									...
									<div class="form-group col-md-6">
										<label>职称</label>
										<input name="zhicheng"  id="zhicheng" name="zhicheng" class="form-control" placeholder="职称">
									</div>
									<div class="form-group col-md-6">
										<label>电话</label>
										<input name="dianhua"  id="dianhua" name="dianhua" class="form-control" placeholder="电话">
									</div>
	...
	<script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("daoshi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
