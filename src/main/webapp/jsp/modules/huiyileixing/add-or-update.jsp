		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑会议类型</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑会议类型</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">会议类型信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>会议类型</label>
										<input name="huiyileixing" id="huiyileixing" name="huiyileixing" class="form-control" placeholder="会议类型">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "huiyileixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("huiyileixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("huiyileixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("huiyileixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#huiyileixing").val(ruleForm.huiyileixing);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.huiyileixing != null && res.data.huiyileixing != ''){
						...
						$("#huiyileixing").val(res.data.huiyileixing);
						$("#huiyileixing").attr('readonly','readonly');
					}
				}
			});  
            }
