...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">学术周报评论表管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学术周报评论表管理</span></li>
								<li class="breadcrumb-item active"><span>学术周报评论表列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学术周报评论表列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										用户名
									</label>
									<input type="text" id="nicknameSearch" class="form-control form-control-sm" placeholder="请输入用户名" aria-controls="tableId">
									<label>
										评论内容
									</label>
									<input type="text" id="contentSearch" class="form-control form-control-sm" placeholder="请输入评论内容" aria-controls="tableId">
	...
	<script>
		...
		var tableName = "discussxueshuzhoubao";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("discussxueshuzhoubao/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				...
				content : searchForm.content,	
        			refid : window.sessionStorage.getItem('refid'),
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var btnGroup = document.createElement('td');
                        ...
                        //评论回复按钮
                        var discussReplyBtn = document.createElement('button');
                        var discussReplyAttr = 'discussReply(' +  item.id + ')';
                        discussReplyBtn.setAttribute("type","button");
                        discussReplyBtn.setAttribute("class","btn btn-warning btn-sm 回复");
                        discussReplyBtn.setAttribute("onclick",discussReplyAttr);
                        discussReplyBtn.innerHTML = "回复"
                        btnGroup.appendChild(discussReplyBtn)
			//删除按钮
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussxueshuzhoubao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("discussxueshuzhoubao"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"discussxueshuzhoubao");
