						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="xueyuan" name="xueyuan" class="form-control" v-model="ruleForm.xueyuan" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>专业</label>

									<input id="zhuanye" name="zhuanye" class="form-control" v-model="ruleForm.zhuanye" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>班级</label>
