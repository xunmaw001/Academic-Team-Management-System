		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑学生签退</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学生签退管理</span></li>
								<li class="breadcrumb-item active"><span>编辑学生签退</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生签退信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>班级</label>
										<input name="banji" id="banji" name="banji" class="form-control" placeholder="班级">
									</div>
									<div class="form-group col-md-6">
										<label>签退时间</label>
										<div id="qiantuishijianDate" class="input-append date form_datetime">
											<input id="qiantuishijian-input" name="qiantuishijian" size="20" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>备注</label>
										<input name="beizhu" id="beizhu" name="beizhu" class="form-control" placeholder="备注">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xueshengqiantui/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("xueshengqiantui/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xueshengqiantui/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xueshengqiantui/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#qiantuishijian-input").val(getCurDateTime());
			$("#qiantuishijianDate").datetimepicker({ 
				autoclose: true,
		...
		function calculationSE(colName){
			//单列求和接口
			http("xueshengqiantui"+colName,"GET",{
				tableName: "xueshengqiantui",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
		...
		function dataBind(){
			...
			$("#qiantuishijian-input").val(ruleForm.qiantuishijian);
			...
			position.longitude = ruleForm.longitude;
			position.latitude = ruleForm.latitude;
			position.address = ruleForm.fulladdress;
			$('#fulladdressMap').val(position.address);
		}		
		//图片显示
		function showImg(){
		}		
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.qiantuishijian != null && res.data.qiantuishijian != ''){

						$("#qiantuishijian-input").val(res.data.qiantuishijian);
						$('#qiantuishijianFileName').val(res.data.qiantuishijian)
					}
