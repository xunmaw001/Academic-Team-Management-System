<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		.top-brand {
			...
			background-color: rgba(108, 133, 23, 1);
		...
		.top-brand .nav .dropdown-menu.profile::before {
			left: 100%;
			margin-left: -28px;
			border-bottom-color: rgba(166, 150, 134, 1);
		}
		...
		.top-brand .nav .dropdown-menu.profile h5 {
			...
			border-style: solid;
			border-color: #333;
			background-color: rgba(166, 150, 134, 1);
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">学术团队管理系统</a>
						</div>
