...
<html>
	...
	<body>
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent","borderStyle":"solid"}'>
				<div class="box" style='width:80%'>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>会议主题</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="huiyizhuti" id="huiyizhuti" placeholder="会议主题" autocomplete="off" class="layui-input">
						</div>
					<div class="item-list">
						...
						<select :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' style="display:block" name="huiyileixing" id="huiyileixing" lay-filter="huiyileixing">
							<option value="">请选择</option>
							<option v-for="(item,index) in huiyileixingOptions" v-bind:key="index" :value="item">{{item}}</option>
						</select>
					</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>参会人员</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="canhuirenyuan" id="canhuirenyuan" placeholder="参会人员" autocomplete="off" class="layui-input">
						</div>
		...
		<div v-if="1 == 1" style="position: absolute;left: 0;top: 0;transform: translate3d(-100%, 0, 0);" :style='{"padding":"0 20px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0 0px 0 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"140px","borderStyle":"solid","height":"auto"}'>
	    		<div style="text-align: center;cursor: pointer;box-sizing: border-box;" class="category-search" :index="-1" :style='swiperIndex==-1?{"padding":"0 10px","boxShadow":"4px -4px 0 #F3A183","margin":"4px 0","borderColor":"rgba(243, 161, 131, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"4px 1px 1px","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"dashed solid solid"}:{"padding":"0 10px","boxShadow":"4px -4px 0px #ABABAB","margin":"10px 0","borderColor":"rgba(194, 194, 194, 1)","backgroundColor":"#fff","color":"rgba(171, 171, 171, 1)","borderRadius":"0","borderWidth":"4px 1px 1px","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"dashed solid solid"}'>全部</div>
			<div v-for="(item,index) in categoryList" :key="index" >
				<div style="text-align: center;cursor: pointer;box-sizing: border-box;" :style='swiperIndex==index?{"padding":"0 10px","boxShadow":"4px -4px 0 #F3A183","margin":"4px 0","borderColor":"rgba(243, 161, 131, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"4px 1px 1px","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"dashed solid solid"}:{"padding":"0 10px","boxShadow":"4px -4px 0px #ABABAB","margin":"10px 0","borderColor":"rgba(194, 194, 194, 1)","backgroundColor":"#fff","color":"rgba(171, 171, 171, 1)","borderRadius":"0","borderWidth":"4px 1px 1px","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"dashed solid solid"}' :index="index" class="category-search">{{categoryList[index]}}</div>
			</div>
		</div>
							<div @click="jump('../huiyitongzhi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"20px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(249, 249, 249, 1)","borderRadius":"0 20px 20px 0","borderWidth":"0","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(243, 161, 131, 1)","borderRadius":"0 30px 30px 0","borderWidth":"4px","width":"90%","borderStyle":"solid","height":"330px"}' :src="item.fengmian?baseurl+item.fengmian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}' class="name">{{item.huiyizhuti}}</div>
									</div>
								</div>
							</div>
						</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/huiyileixing/huiyileixing`,'get',{},(res)=>{
                			vue.huiyileixingOptions = res.data
        			});
				...
				//类型搜索
				  ...
				  // 获取列表数据
				  http.request('option/huiyileixing/huiyileixing', 'get', {}, function(res) {
				...
				if(category!=null && category!='全部') {
					vCategory = category;
					if (jquery('#huiyizhuti').val()) {
						param['huiyizhuti'] = '';
					}
					if (jquery('#huiyileixing').val()) {
						param['huiyileixing'] = '';
					}
					if (jquery('#canhuirenyuan').val()) {
						param['canhuirenyuan'] = '';
					}
				}
				if(vCategory!='' && category!='全部') {
					param['huiyileixing'] = category;
				}

			        if (jquery('#huiyizhuti').val()) {
			          param['huiyizhuti'] = jquery('#huiyizhuti').val() ? '%' + jquery('#huiyizhuti').val() + '%' : '';
			        }
			        if (jquery('#huiyileixing').val()) {
			          param['huiyileixing'] = jquery('#huiyileixing').val() ? jquery('#huiyileixing').val() : '';
			        }
			        if (jquery('#canhuirenyuan').val()) {
			          param['canhuirenyuan'] = jquery('#canhuirenyuan').val() ? '%' + jquery('#canhuirenyuan').val() + '%' : '';
			        }
				...
				if (jquery('#canhuirenyuan').val()) {
					...
					// 获取列表数据
					http.request('huiyitongzhi/list', 'get', param, function(res) {
