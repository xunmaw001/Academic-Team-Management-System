...
public class DaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DaoshiEntity user = daoshiService.selectOne(new EntityWrapper<DaoshiEntity>().eq("jiaoshigonghao", username));
    ...
    public R register(@RequestBody DaoshiEntity daoshi){
    	...
    	DaoshiEntity user = daoshiService.selectOne(new EntityWrapper<DaoshiEntity>().eq("jiaoshigonghao", daoshi.getJiaoshigonghao()));
		if(user!=null) {
